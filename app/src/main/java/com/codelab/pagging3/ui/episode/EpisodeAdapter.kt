...
import com.codelab.pagging3.databinding.ItemEpisodeBinding
import javax.inject.Inject

class EpisodeAdapter @Inject constructor() : PagingDataAdapter<Episode, EpisodeAdapter.EpisodeViewHolder>(EpisodeComparator) {
